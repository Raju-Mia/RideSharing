...
class OrganizationTripListForLiveTrackingSerializer(serializers.ModelSerializer):  
...
class OrganizationTripCurrentLocationSerializer(serializers.ModelSerializer):
...
class OrganizationTripInfoForLiveTrackingSerializer(serializers.ModelSerializer):
    current_location = serializers.SerializerMethodField()
