...
class UnpaidCompletedTripListSerializer(serializers.ModelSerializer):
...
class UnpaidCompletedTripDetailSerializer(serializers.ModelSerializer):
    organization_name = serializers.CharField(source='user.organization.name', read_only=True)
...
class OrganizationAccountSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        fields = ['total_trips_completed', 'total_dealings', 'total_paid', 'final_fare_with_org_commission', 'total_org_commission_earn']
